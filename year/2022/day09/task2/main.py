...
Puzzle: Advent of Code (year=2022 ; day=9 ; task=2)
"""
...
def main() -> None:
    ...
    knots = [(0, 0) for _ in range(10)]  # knots to be tracked
    ...
    for instruction in sys.stdin:
        ...
        for _ in range(1, c + 1):
            ...
            for i, j in zip(range(len(knots) - 1), range(1, len(knots))):  # update body and tail
