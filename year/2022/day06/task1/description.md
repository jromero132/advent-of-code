...
As if inspired by comedic timing, the device emits a few colorful sparks[^1].
...
[^1]: [colorful sparks] The magic smoke, on the other hand, seems to be contained... FOR NOW!
