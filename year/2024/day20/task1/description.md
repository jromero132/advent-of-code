...
The race takes place on a particularly long and twisting code path; programs compete to see who can finish in the **fewest picoseconds**. The winner[^1] even gets their very own [mutex](https://en.wikipedia.org/wiki/Lock_(computer_science))!
...
[^1]: [winner] If we give away enough mutexes, maybe someone will use one of them to fix the race condition!
