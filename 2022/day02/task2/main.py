...
def solve(in_parsed: list) -> str:
    ...
    move_to_do = {}  # move to do based on how the game should end
    move_to_do["A Y"] = move_to_do["B X"] = move_to_do["C Z"] = 'X'
    move_to_do["A Z"] = move_to_do["B Y"] = move_to_do["C X"] = 'Y'
    move_to_do["A X"] = move_to_do["B Z"] = move_to_do["C Y"] = 'Z'

    in_parsed = [game[:-1] + move_to_do[game] for game in in_parsed]  # get the value of the real game
